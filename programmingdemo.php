...
<?php
			...
			$q="select * from programming_languages where id=19";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 18";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 9";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 13";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 3";
