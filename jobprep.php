...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/sc.jpg);
}
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b>COGNITIVE SKILL</b></h2>
 								<div class="sub-heading">
 									Following are the available Topics Related Cognitive <br>
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 23";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 24";
