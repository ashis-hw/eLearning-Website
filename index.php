...
<head>
	...
	<title>Victory educational platform-main</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="logout.php" id="" class="" ><i class='fa fa-sign-out'></i>logout</a></li>
					<li> <a href="" id="our-location" class="btn-success" ><i class='fa fa-user-o'></i> &nbsp<?php echo $_SESSION['username'];   ?> </a> </li>
         	...
         	<div class="row">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="jobprep.php">COGNITIVE SKILL</a></h3>
         				<p>
         					Here you will find all the lecture tutorials related to  cognitive skills
         					like APTITUDE,REASONING,VERBAL etc
         				</p>
         			</div>
         		</div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="interview.php">CS CORE SUBJECTS</a></h3>
         				<p>
         					Here you will find all the lecture tutorials related to  cs core subjects
         					like OS,DBMS,NETWORK etc
         				</p>
         			</div>
         		</div>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href="practiceq.php">PRACTICE QUISTIONS</a></h3>
         				<p>
         					Here you will find all the practice questions  related to  Programming language
         					Core Subjects & APTITUDE,REASONING,VERBAL etc
         				</p>
         			</div>
         		</div>
