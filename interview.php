...
<html>
<head>
	<title>computer science core subjects</title>
	<link rel = "icon" href = "img/006.png" type = "image/x-icon">
	<!----css file link-->
...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/core.jpg);
}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead"><img src= "img/006.png">Victory</h1>
			</div>
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b>CS CORE SUBJECTS</b></h2>
 								<div class="sub-heading">
 									Following are the available Topics Related CS Core Subjects <br>
...
<?php
			...
			//$q=("select * from programming_languages where id=22");
			//$q= mysqli_query($mysqli, "SELECT * FROM programming_languages ORDER BY id DESC"); 
		
			$q="select * from programming_languages where id= 25";
			
			$query=mysqli_query($con,$q);
		
			//$query2=mysqli_query($con,$s);
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 26";
...
$con=mysqli_connect('localhost','root');
			...
			$q="select * from programming_languages where id= 27";
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                ...
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2021</span><span> </span><span>LEARN TODAY</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              <dl class="contact-list">
                <dt>Address:</dt>
                <dd>DH Road, DHGC, DH 400101</dd>
              </dl>
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">learntoday0@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
                <dd><a href="tel:#">+91 900000512</a> <span>or</span> <a href="tel:#">+91 7918888809</a>
                </dd>
              </dl>
            </div>
