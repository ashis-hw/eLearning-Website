...
.div1                           /* for title image*/
{
   ...
   position: relative;
    height: 500px;
    width: 1263px;
    background:url(uploadimg/practice.png);
}
 					...
 					<div class="row">
 						<div class="col-xs-12">
 							<div class="section-title text-center">
 								<h2><b>PRACTICE QUISTIONS</b></h2>
 								<div class="sub-heading">
 									Following are the available Practice questions Related All The Above Course <br>
...
<?php
			...
			$q="select * from programming_languages where id= ";
